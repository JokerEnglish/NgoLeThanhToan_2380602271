...
import os
os.environ['QT_QPA_ PLATFORM_PLUGIN_PATH'] = "../platfroms"
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label.setGeometry(QtCore.QRect(300, 40, 191, 16))
        font = QtGui.QFont()
